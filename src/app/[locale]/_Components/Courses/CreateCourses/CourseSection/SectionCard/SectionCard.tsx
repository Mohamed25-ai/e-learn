    ...
    return (
        <section className="px-5 md:px-0">
            ...
            <div className="space-y-4 md:w-3/4 mx-auto ">
                        ...
                        <div className="flex w-full gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <CardContent className="px-0">
                                    <Input id={String(idx)} disabled={addedSectionState[value] || isLoading[idx]} key={value} ref={(element) => { sectionData.current[idx] = element }} className="shadow-none bg-transparent focus-visible:ring-0 border-0 border-b-2 
                                    border-border  rounded-none   py-5" placeholder={addedSectionState[value] ? "This section is added before" : "Enter Section Title"} />
                                </CardContent>
                            </div>
                        </div>
                ...
                <div>
                    <Button onClick={handleAddSection} className="w-full flex justify-center py-5 
                        bg-white border-dashed border-2 border-(--primary-color) 
                ...
                {createCorseStore?.sectionCreatedSuccessifuly?.length > 0 && <Button
                    ...
                    className="w-full flex justify-center py-5 bg-white border-dashed border-2
                        border-(--primary-color) cursor-pointer text-(--primary-color)
