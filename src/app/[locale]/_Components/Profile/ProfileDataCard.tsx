"use client"
import { faAward, faBookOpen, faCircleCheck, faCircleUser, faClock, faFloppyDisk, faPenToSquare, faXmark } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { ProfileProps } from './profile.types'
import Image from 'next/image'
import { useAppDispatch, useAppSelector } from '@/hooks/hooks'
import { setEditUserProfileState, toggleEditUserProfile } from '@/store/redux/userprofile/userprofile.slice'


export default function ProfileDataCard({ data }: ProfileProps) {
    const {isUserEditNow} = useAppSelector((state) => state.userProfileSlice);
