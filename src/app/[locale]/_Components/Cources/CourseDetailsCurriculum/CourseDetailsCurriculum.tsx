...
export default async function CourseDetailsCurriculum({courdeId}:CourseDetailsCurriculumProps) {
  ...
  return (
    <section className='mt-5 px-5'>
      ...
      {sections?.data?.data.map((section:SectionData)=>(<CoursesAccordionWrapper key={section?.id} data={section} />))}
