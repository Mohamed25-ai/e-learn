...
import { ContentType, CourseContentFormPropsType, SubmitContentFormType } from "./createcoursecontent.types";
...
import { getFileRules, sectionRules, titleRules } from "./createCourseContent.validation";
                ...
                <div className="flex flex-col gap-6 p-4 sm:p-6 lg:p-7">
                    ...
                    <div className="flex flex-col gap-5 lg:flex-row lg:items-start">
                        ...
                        <div className="flex justify-center lg:justify-start">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-(--primary-light) text-sm font-semibold text-(--primary-color)">
                                {fromOrder}
                            </div>
                        </div>
                        {/* Main Content */}
                                                ...
                                                return (
                                                    <>
                                                        ...
                                                        <CategoryCombobox
                                                            isStepThree
                                                            value={field.value}
                                                            isContentAddedBefore={isCardAddedBrefore && !editCurrentCard[fromOrder]}
                        ...
                        <div className="flex justify-end lg:justify-center">
                            ...
                            {isCardAddedBrefore && !editCurrentCard[fromOrder] && <button
